...
Your mission in this problem is to filter through the endless sea of elements and separate the worthy from the unworthy. Using the mighty [filter](https://developer.mozilla.org/ru/docs/Web/JavaScript/Reference/Global_Objects/Array/filter) array method, you must pass each element through a test and return a new array with only those that succeed!
